...
Built phase-by-phase through [GSD](.planning/). Started as "oh I'll ship six phases, a cute little tower + radar + merge UI app." Now there are nineteen, plus a decimal (11.1), and the count keeps going up every time I actually run the thing. Phases 11-17 were added *after* v1.0 shipped because once you have a functional ATC radar you cannot stop asking what if the radar was cooler. Phase 18 was added because running four agents at once filled the registry in about ten seconds. Phase 19 was added because the chat UI showed hook noise, duplicated text blocks, and literal triple-backticks where code blocks should go. Classic.
...
Now it's nineteen phases long (twenty if you count 11.1) so...
